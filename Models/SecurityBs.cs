...
namespace MVCModelApp.Models
{
    ...
    public class EasyMvcMembershipProvider : MembershipProvider
    {
        private _IAllRepository<TblLogin> interfaceobj;
        ...
        {
            int count = interfaceobj.GetModel().Where(x => x.LoginName == username && x.Password == password).Count();
            if (count != 0)
                return true;
            else
                return false;
    ...
    public class EasyMvcRoleProvider : RoleProvider
    {
         private _IAllRepository<TblLogin> interfaceobj;
        ...
        public override string[] GetRolesForUser(string username)
        {
                ...
                string[] s = { interfaceobj.GetModel().Where(x => x.LoginName == username).FirstOrDefault().LoginType };
                return s;
